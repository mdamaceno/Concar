...
public class PropostaDAO {
    ...
    private String[] colunas = {
            ...
            DatabaseHelper.COLUMN_P_VALORENTRADA, DatabaseHelper.COLUMN_P_VALORCARRO, DatabaseHelper.COLUMN_P_VALORFINAL,
    ...
    public boolean create(Proposta proposta) {
        ...
        values.put(DatabaseHelper.COLUMN_P_VALORFINAL, proposta.getValor_final());
    ...
    private Proposta cursorToProposta(Cursor cursor) {
        ...
        proposta.setValor_final(cursor.getDouble(5));
        proposta.setIdCarro(cursor.getInt(6));
        proposta.setIdCliente(cursor.getInt(7));
